---
name: slack
description: Use slack to react, manage pins, send/edit/delete messages, and fetch member info. The tool uses the bot token configured for Clawdbot.
tags: slack,messaging,channel
---
